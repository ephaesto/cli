...
import {
	cleanRenderCommandContext,
	createRenderCommandContext,
} from "./renderCommandContext";
...
export async function renderCommand({
	...
	createRenderCommandContext(seed, { delay, stdout: originalStdoutWrite });
	...
	const finish = (): RenderCommand => {
		...
		cleanRenderCommandContext(seed);
		cleanEventBus(seed);
